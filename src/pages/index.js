        ...
        <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
          <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
            <div className="space-y-5 sm:space-y-4">
              ...
              <p className="text-xl text-gray-300">Plus de <b>15 années d'expérience</b> en développement mises à profit d'applications Web modernes propulsées par <b>Laravel / VueJS / TailwindCSS</b>.</p>
      ...
      <footer className="bg-gray-900 border-t border-gray-800">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          <div class="mt-8 md:mt-0 md:order-1">
            <p class="text-center text-base text-gray-300">&copy; {new Date().getFullYear()} Übermeows</p>
          </div>
        </div>
      </footer>
    </>
